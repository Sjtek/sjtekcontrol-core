...
public class ResponseTest {
    ...
    public void responseJson() {
        ...
        Assert.assertEquals(responseCollection.getLights().isLight1(), false);
        Assert.assertEquals(responseCollection.getQuotes().getQuote(), "Alleen massaproductie");
    }
